...
class MyApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.tempSureButton = getButton("Hold",width=140,event=self.tempSureButtonClickedEvent)
        self.nextButton = getButton("Next Sentence",width=140,event=self.nextButtonClickedEvent)
    ...
    def run(self):
        ...
        try:    
            ...
            QMessageBox.information(self,"Prompt","Thanking for annotating the whole data.",QMessageBox.Ok,QMessageBox.Ok)
    ...
    def sureButtonClickedEvent(self):
        ...
        if results :
            ...
            if writeFile(results) :
                ...
                QMessageBox.warning(self,"Warning","Please you have annotated all necessary information.",QMessageBox.Ok,QMessageBox.Ok)
                       
        else:
            QMessageBox.warning(self,"Warning","Please choose a semantic representation in Conjunction form to save.",QMessageBox.Ok,QMessageBox.Ok)
    ...
    def resetResFile(self):
        ...
        def readSentenceFileMap(filename):
            try:
                ...
                QMessageBox.warning(self,"Error","Error when reading configure files")
                traceback.print_exc()
