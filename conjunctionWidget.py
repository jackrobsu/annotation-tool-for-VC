...
class ConjunctionWidget(QMainWindow,QObject):
    ...
    def ContentAdd(self):
        ...
        '''
        controlContents = []
        self.conjunctionLabel , self.conjunctionContent = addContent(self,"Conjunction",controlcontents=controlContents,contentWidth=120,num=0,signal=self.textClickSignal,tagWidth=70)
        ...
        self.leftSentenceLabel , self.leftSentenceContent , self.leftRefTag= addContent(self,"Left Clause",controlcontents=controlContents,contentWidth=120,num=1,signal=self.textClickSignal,tagWidth=70,checkBoxHidden=False,needTagTextEdit=True,isConjunction=True)
        ...
        self.rightSentenceLabel , self.rightSentenceContent , self.rightRefTag = addContent(self,"Right Clause",controlcontents=controlContents,contentWidth=120,num=2,signal=self.textClickSignal,tagWidth=70,checkBoxHidden=False,needTagTextEdit=True,isConjunction=True)
        # self.addPadding(controlContents,3)
    ...
    def gridAddForLeftWindow(self,controlContents):
        ...
        self.buttonSaver.setText("Save Form")
