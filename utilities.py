...
def addContent(obj,text,controlcontents,num=0,signal=None,tagHeight=30,tagWidth=30,contentHeight=30,contentWidth=100,needCheckBox=False,checkBoxHidden=True,needTagTextEdit=False,noCheckBox=False,noTagTextEdit=False,isConjunction=False):
    '''
        用于给页面添加基本的标签和文本编辑框
